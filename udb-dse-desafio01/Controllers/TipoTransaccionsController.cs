...
namespace udb_dse_desafio01.Controllers
{
    public class TipoTransaccionsController : Controller
    {
        ...
        {
            return View(db.TransaccionTipos.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            TipoTransaccion tipoTransaccion = db.TransaccionTipos.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre")] TipoTransaccion tipoTransaccion)
        {
            if (ModelState.IsValid)
            {
                db.TransaccionTipos.Add(tipoTransaccion);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre")] TipoTransaccion tipoTransaccion)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            TipoTransaccion tipoTransaccion = db.TransaccionTipos.Find(id);
            db.TransaccionTipos.Remove(tipoTransaccion);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
